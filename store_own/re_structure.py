...
CAT_NO = re.compile(string_pattern.format(tag=Product.props[0]))
EAN = re.compile(string_pattern.format(tag=Product.props[1]))
QUANTITY = re.compile(int_pattern.format(tag=Product.props[2]))
AVAIL = re.compile(string_pattern.format(tag=Product.props[3]))
POST_TIME = re.compile(string_pattern.format(tag=Product.props[4]))
